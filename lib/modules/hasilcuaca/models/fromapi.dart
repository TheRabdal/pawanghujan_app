  ...
  factory FromApi.fromJson(Map<String, dynamic> json) {
    return FromApi(
      ...
      cuaca: json["cuaca"] == null
          ? []
          : List<Cuaca>.from(json["cuaca"]!.map((x) => Cuaca.fromJson(x))),
      basis: json["basis"],
      utama: Map.from(
        json["utama"],
...
class Angin extends Equatable {
  ...
  Angin copyWith({double? kecepatan, int? derajat, double? embusan}) {
    return Angin(
  ...
  @override
  List<Object?> get props => [kecepatan, derajat, embusan];
}
...
class Awan extends Equatable {
  ...
  Awan copyWith({int? semua}) {
    return Awan(semua: semua ?? this.semua);
  }

  factory Awan.fromJson(Map<String, dynamic> json) {
    return Awan(semua: json["semua"]);
  }

  Map<String, dynamic> toJson() => {"semua": semua};
...
class Cuaca extends Equatable {
  ...
  Cuaca copyWith({int? id, String? utama, String? deskripsi, String? icon}) {
    return Cuaca(
      id: id ?? this.id,
      utama: utama ?? this.utama,
  ...
  @override
  List<Object?> get props => [id, utama, deskripsi, icon];
}
...
class Koordinat extends Equatable {
  ...
  Koordinat copyWith({int? bujur, int? lintang}) {
    return Koordinat(
  ...
  factory Koordinat.fromJson(Map<String, dynamic> json) {
    return Koordinat(bujur: json["bujur"], lintang: json["lintang"]);
  }

  Map<String, dynamic> toJson() => {"bujur": bujur, "lintang": lintang};
  ...
  @override
  List<Object?> get props => [bujur, lintang];
}
...
class Sistem extends Equatable {
  ...
  @override
  List<Object?> get props => [negara, matahariterbit, matahariterbenam];
}
